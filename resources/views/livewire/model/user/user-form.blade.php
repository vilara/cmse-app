                                ...
                                <div class="px-4 py-5 bg-gray-300 space-y-6 sm:p-6">
                                    <div class="grid grid-cols-4 gap-6">
                                        ...
                                        <div class="col-span-3 sm:col-span-2">
                                            ...
                                            <x-jet-input id="user.email" type="text" wire:model.lazy="user.email" />
                                    ...
                                    <div class="grid grid-cols-8 gap-6">
                                        <div class="col-span-6 sm:col-span-4">
                                            ...
                                            <x-jet-input id="user.cpf" type="text" wire:model.lazy="user.cpf" />
                                            <x-jet-input-error for="user.cpf" class="mt-2" />
                                        </div>
                                        <div class="col-span-6 sm:col-span-2">
                                            <x-jet-label for="password" value="Senha" />
                                            <x-jet-input id="password" type="password" wire:model.lazy="password" />
                                    ...
                                    <div class="grid grid-cols-4 gap-6">
                                        <div class="col-span-3 sm:col-span-2">
                                            ...
                                            <x-jet-input id="detail.nome_completo" type="text"
                                                wire:model.lazy="detail.nome_completo" />
                                            <x-jet-input-error for="detail.nome_completo" class="mt-2" />
                                        </div>
                                        <div class="col-span-3 sm:col-span-2">
                                            <x-jet-label for="detail.idt" value="Identidade" />
                                            <x-jet-input id="detail.idt" type="text" wire:model.lazy="detail.idt" />
                                    ...
                                    <div class="grid grid-cols-8 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-2">
                                            ...
                                            <x-select disabled='' ref="nomeSecao" :arra="$sections"
                                                wire:model.lazy="detail.section_id" />
                                        ...
                                        <div class="col-span-6 sm:col-span-2">
                                            ...
                                            <x-select disabled='' ref="nomeCg" :arra="$cargos"
                                                wire:model.lazy="detail.cargo_id" />
                                    ...
                                    <div class="grid grid-cols-8 gap-6">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="mt-4 space-y-4">
                                                    <div class="flex items-center">
                                                        <input wire:model.lazy="detail.sexo" id="detail.sexo" name="detail.sexo" value="masculino"
                                                            type="radio"
                                                    ...
                                                    <div class="flex items-center">
                                                        <input wire:model.lazy="detail.sexo" id="detail.sexo1" name="detail.sexo" value="feminino"
                                                            type="radio"
                                                            class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                        ...
                                        <div class="col-span-8 sm:col-span-2">
                                            <fieldset>
                                                ...
                                                <div class="mt-4 space-y-4">
                                                    <div class="flex items-center">
                                                        <input wire:model.lazy="detail.detailable_type" id="type"
                                                    ...
                                                    <div class="flex items-center">
                                                        <input wire:model.lazy="detail.detailable_type" id="type1"
                                        ...
                                        <div class="grid grid-cols-5 gap-6">
                                            <div class="col-span-4 sm:col-span-1">
                                                ...
                                                <x-select disabled='' ref="abrev" :arra="$forcas"
                                                    wire:model.lazy="militar.forca_id" />
                                            ...
                                            <div class="col-span-4 sm:col-span-1">
                                                ...
                                                <x-select disabled='' ref="siglaPg" :arra="$postograds"
                                                    wire:model.lazy="militar.postograd_id" />
                                            ...
                                            <div class="col-span-4 sm:col-span-3">
                                                ...
                                                <x-jet-input id="militar.nome_guerra" type="text"
                                                    wire:model.lazy="militar.nome_guerra" />
                                        ...
                                        <div class="grid grid-cols-8 gap-6">
                                            <div class="col-span-8 sm:col-span-2">
                                                <fieldset>
                                                    ...
                                                    <div class="mt-4 space-y-4">
                                                        <div class="flex items-center">
                                                            <input wire:model.lazy="militar.situacao" id="sit" name="militar.situacao"
                                                        ...
                                                        <div class="flex items-center">
                                                            <input wire:model.lazy="militar.situacao" id="sit1" name="militar.situacao"
                                            ...
                                            <div class="grid grid-cols-4 gap-6">
                                                <div class="col-span-4 sm:col-span-2">
                                                    ...
                                                    <x-jet-input id="civil.primeiro_nome" type="text"
                                                        wire:model.lazy="civil.primeiro_nome" />
