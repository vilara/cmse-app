                                ...
                                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    ...
                                    <div class="col-span-8 sm:col-span-4">
                                        <div class="col-span-3 sm:col-span-2">
                                            ...
                                            <x-jet-input id="detail.dtNasc" type="date" wire:model="detail.dtNasc" />
                                        ...
                                        <div class="col-span-8 sm:col-span-2">
                                            <fieldset>
                                                ...
                                                <div class="mt-4 space-y-4">
                                                    <div class="flex items-center">
                                                        <input wire:model="detail.detailable_type" id="type" name="detail.detailable_type" value="militar" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                        <label for="type"
                                                            class="ml-3 block text-sm font-medium text-gray-500">
                                                            Militar
                                                        </label>
                                                    ...
                                                    <div class="flex items-center">
                                                        <input wire:model="detail.detailable_type" id="type1" name="detail.detailable_type" value="civil" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                        <label for="type1"
                                                            class="ml-3 block text-sm font-medium text-gray-500">
                                                            Civil
                                                        </label>
                                ...
                                <div class="grid grid-cols-8 gap-6">
                                    <div class="col-span-8 sm:col-span-2">
                                        <fieldset>
                                            ...
                                            <div class="mt-4 space-y-4">
                                                <div class="flex items-center">
                                                    <input wire:model="situacao" id="sit" name="situacao" type="radio" value="ativa"
                                                        class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                    <label for="sit"
                                                        class="ml-3 block text-sm font-medium text-gray-500">
                                                        Reserva
                                                ...
                                                <div class="flex items-center">
                                                    <input wire:model="situacao" id="sit1" name="situacao" type="radio" value="reserva"
                                                        class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                    <label for="sit1"
                                                        class="ml-3 block text-sm font-medium text-gray-500">
                                                        Ativa
